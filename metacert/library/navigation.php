...
register_nav_menus(array(
    'footer-menu' => 'Footer Bar', // registers the menu in the WordPress admin menu editor
    'footer-right-menu' => 'Footer Right Bar',
...
function foundationPress_top_bar_r() {
    wp_nav_menu(array( 
        ...
        'container_class' => '',                        // class of container
        'menu' => '',                                   // menu name
        'menu_class' => 'footer-right-menu',            // adding custom nav class
        'theme_location' => 'footer-right-menu',        // where it's located in the theme
        'before' => '',                                 // before each link <a> 
        'after' => '',                                  // after each link </a>
        'link_before' => '',                            // before each link text
        'link_after' => '',                             // after each link text
