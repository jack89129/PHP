        ...
        Foundation.libs.offcanvas = {
            ...
            events: function() {
                ...
                "move" === this.settings.open_method ? (c = "move-", d = "right", e = "left") : "overlap" === this.settings.open_method && (c = "offcanvas-overlap"), b(this.scope).off(".offcanvas").on("click.fndtn.offcanvas", ".left-off-canvas-toggle", function(b) {
                    ...
                    }).on("click.fndtn.offcanvas", ".left-off-canvas-menu a.left-off-canvas-toggle", function(b) {
...
jQuery( document ).ready(function($) {
    ...
    SITE = {
        ...
        initMobileMenu: function() {
            ...
            $('.mobile-menu-wrapper .close-menu').on('click', function(){
                $('.mobile-menu-wrapper').slideToggle();
            });
            /*$('.mobile-api-sidebar .btn-api-dropdown').on('click', function(){
                if ( $('.mobile-api-sidebar').hasClass('open') ) {
                    $('.mobile-api-sidebar').removeClass('open');
                    $('.api-sidebar').slideToggle();
                } else {
                    $('.mobile-api-sidebar').addClass('open');
                    $('.api-sidebar').slideToggle();
                }
            });*/
            $('.mobile-api-sidebar').on('click', function(){
                if ( $('.mobile-api-sidebar').hasClass('open') ) {
                    $('.mobile-api-sidebar').removeClass('open');
                    $('.api-sidebar').slideToggle();
                } else {
            ...
            /*$('.price-box .btn-plan').on('click', function(){
                $('.price-box.active').removeClass('active');
                $(this).parent().addClass('active');
            });*/
            $('.price-block .price-box').on('click', function(){
                $('.price-box.active').removeClass('active');
                $(this).addClass('active');
            });
            $('.team-block-section a.link-member').on('click', function(){
                var pid = $(this).attr('pid');
                $(".member-body.active").css('display', 'none');
                $(".member-body.active").removeClass('active');
                $("#"+pid).addClass('active');
                $("#"+pid).slideToggle();
                 $("html, body").animate({ scrollTop: $("#"+pid).offset().top }, 800);
            });
            $('.signup-wrapper .btn-type').on('click', function(){
                $('.signup-wrapper .btn-type.active').removeClass('active');
                $(this).addClass('active');
            });
        },
    };
