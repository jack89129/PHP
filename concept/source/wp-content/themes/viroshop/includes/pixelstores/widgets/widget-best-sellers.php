...
class BestSellers extends WP_Widget
{
    ...
    function BestSellers(){
		$widget_ops = array('description' => 'Display a list of your best selling products on your site.');
		$control_ops = array('height' => 300);
		parent::WP_Widget(false,$name='VS Best Sellers',$widget_ops,$control_ops);
    }
...
function BestSellersWidgetInit() {
  register_widget('BestSellers');
}

add_action('widgets_init', 'BestSellersWidgetInit');
