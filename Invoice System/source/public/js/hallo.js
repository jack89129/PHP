  ...
  (function(jQuery) {
    return jQuery.widget("IKS.hallolink", {
      ...
      populateToolbar: function(toolbar) {
        ...
        dialog = jQuery("<div id=\"" + dialogId + "\">        <form action=\"#\" method=\"post\" class=\"linkForm\">          <input class=\"url\" type=\"text\" name=\"url\"            value=\"" + this.options.defaultUrl + "\" />          <input type=\"submit\" id=\"addlinkButton\" value=\"Invoegen\" />        </form></div>");
  ...
  (function(jQuery) {
    jQuery.widget('IKS.hallobutton', {
      ...
      _createButton: function(id, command, label, icon) {
        ...
        return jQuery("<button id=\"" + id + "\"        class=\"" + (classes.join(' ')) + "\" title=\"" + this.translate(label) + "\">          <span class=\"ui-button-text\">            <i class=\"" + icon + "\"></i>          </span>        </button>");
      }
    });
