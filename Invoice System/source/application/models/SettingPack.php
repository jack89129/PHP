<?php
     ...
     */
    class SettingPack extends Core_ActiveRecord_Row {
        ...
        public function relations(){
            return array(
                ...
                'products' => array('SettingPackProduct', 'pack_id', self::HAS_MANY),
                'receipts' => array('Receipt', 'pack_id', self::HAS_MANY)
            );
        }

        public function __construct($id=null){
            parent::__construct(new SettingPackModel(), $id);
        }

        public function addProduct(SettingPackProduct $product){
        ...
        public function formatNumber($number){
            return Constants::STANDARD_PACK_NUMBER_PREFIX . str_repeat("0", Constants::STANDARD_PACK_NUMBER_PADDING - strlen($number)) . $number;
        }

        public function nextNumber(){
            return SettingsModel::getStandardPackNextNum();
        }
        ...
        public function getStatusKey(){
            if( $this->status == SettingPackModel::STATUS_NEW ){
                return 'new';
            }
            ...
            if( $this->status == SettingPackModel::STATUS_FINAL ){
                return 'packed';
            }
