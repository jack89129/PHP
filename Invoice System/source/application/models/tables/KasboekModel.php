<?php
class KasboekModel extends Jaycms_Db_Model {
    /**
     * The default table name 
     */
    protected $_name = 'kasboek';    
    ...
    public function getMonthKasboek($year_month, &$total=0, &$sum=0.0, &$sum_no_vat=0.0){
        $query = "
                    ...
                    (
                        ...
                        WHERE i.paid_time != '0000-00-00 00:00:00' AND i.status = 'final' AND ip.payment_method = 'cash' AND i.paid_time like '".$year_month."%' 
                        UNION
                        ...
                        WHERE p.paid_time != '0000-00-00 00:00:00' AND pp.payment_method = 'cash' AND p.paid_time like '".$year_month."%' 
                    ) t
                    LEFT JOIN kasboek s ON s.kas_date = t.paid_time
                    ";
        /*
        SELECT s.kas_date mdate, s.afsch afsch, t.number, t.contact, t.credit, t.debit
FROM
